...
const TAB_LIST: { name: string; title: string; icon: TabIcon; iconFocused: TabIcon }[] = [
  ...
  { name: "my-orders", title: "Buyurtmalar", icon: "document-text-outline", iconFocused: "document-text" },
  { name: "earnings", title: "Daromad", icon: "wallet-outline", iconFocused: "wallet" },
